...
let parts = { // Changed to let, as I couldn't change the values on the const (even if we should be able to?)
    head: "",
    body: "",
    arm_right: "",
    arm_left: "",
...
function togglePart(e) { // This code can be used for any part, heads, arms, legs, bodies etc.
  ...
  function removeOldPart() {
    ...
    if (partToHide === "") { // If nothing was previously selected, nothing will be removed
      console.log('Nothing to be removed as nothing was previously selected!');
      addNewPart();
    } else if (partToHide === clickedPart) { // If part already selected, hide it again
