...
tlEnd.from(".endspan", { fontSize: "1rem", duration: 2.5 });
tlEnd.from(".endspan", { fontSize: "10rem", duration: 2.5 });
tlEnd.from(".endspan", { fontSize: "4rem", duration: 2.5 });
tlEnd.to(".endspan", { fontSize: "8rem", duration: 2.5 });
